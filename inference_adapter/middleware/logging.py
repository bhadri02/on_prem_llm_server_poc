...
PII safety rules (Requirement 10.6):
...
class LoggingMiddleware(BaseHTTPMiddleware):
    ...
    Log entry fields (Requirements 10.4, 10.5, 10.6):
    ...
    async def dispatch(self, request: Request, call_next):
        ...
        if _should_emit(level):
            ...
            # --- Apply PII exclusion (Requirement 10.6) ---
            ...
            # --- Emit to stdout; silently discard on any failure (Requirement 10.5) ---
            try:
